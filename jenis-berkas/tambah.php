<?php
  ...
  $judul_halaman = "Tambah jenis berkas";
?>
<html>
<head>
  <?php
    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body table-responsive ">
            <form method="POST" action="<?=$alamat_web?>/jenis-berkas/proses_tambah.php">
              <div class="form-group">
                <label class="form-label">Nama jenis berkas</label>
                <input class="form-control"  type="text" name="nm_berkas" required />
              </div>
              <div class="form-group">
