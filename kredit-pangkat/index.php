    ...
    <section class="content">
      <div class="box">
        ...
        <div class="box-body table-responsive ">
            <a href="<?=$alamat_web?>/kredit-pangkat/tambah.php" class="btn btn-flat  btn btn-success">Tambah Data</a>
            ...
            ?>
                <tr>
                  ...
                  <td><?=$d['peringkat']?></td>
                  <td>
                    <a href="<?=$alamat_web?>/kredit-pangkat/proses_hapus.php?id_jabatan_pangkat=<?=$d['id_jabatan_pangkat']?>" class="btn btn-flat  btn btn-danger">Hapus</a> 
                    <a href="<?=$alamat_web?>/kredit-pangkat/edit.php?id_jabatan_pangkat=<?=$d['id_jabatan_pangkat']?>" class="btn btn-flat  btn btn-primary">Edit</a></td>
                </tr>
            <?php 
              $no++;
              }
