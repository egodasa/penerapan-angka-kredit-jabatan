  ...
  <aside class="main-sidebar">
    <section class="sidebar" style="height: auto;">
      ...
      <ul class="sidebar-menu tree" data-widget="tree">
        ...
        <li>
          <a href="<?=$alamat_web?>/persyaratan">
            <i class="fa fa-list-alt"></i> <span>Beranda</span>
          </a>
        </li>
        <li>
          <a href="<?=$alamat_web?>/pegawai/lihat.php">
            <i class="fa fa-list"></i> <span>Profil Saya</span>
          </a>
        </li>
        <li>
          <a href="<?=$alamat_web?>/usulan/tambah.php">
            <i class="fa fa-toggle-up"></i> <span>Buat usulan Baru</span>
          </a>
        </li>
        <li>
          <a href="<?=$alamat_web?>/usulan">
            <i class="fa fa-list-ol"></i> <span>Usulan Saya</span>
          </a>
        </li>
      </ul>
    </section>
