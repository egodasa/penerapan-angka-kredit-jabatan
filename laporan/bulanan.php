      ...
      <section class="content">
        <div class="box">
              ...
              <div class="form-group">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <span class="input-group-btn">
                    ...
                    <a href="<?=$alamat_web?>/laporan/cetak-bulanan.php<?=$query_string_waktu?>" target="_blank" class="btn btn-success btn-flat">Cetak</a>
                  </span>
                </div>
              </div>
            </form>
          ...
          <div class="box-body table-responsive ">
            <h3 class="box-title">Laporan Pemasukan Bulan <?=namaBulan(date("m", strtotime($waktu)))?>
            </h3>
