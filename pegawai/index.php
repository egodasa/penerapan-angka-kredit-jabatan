      ...
      <section class="content">
        <div class="box">
          ...
          <div class="box-body table-responsive ">
            <a href="<?=$alamat_web?>/pegawai/tambah.php" class="btn btn-flat  btn btn-success">Tambah Data</a>
...
?>
                <tr>
                  ...
                  <td>
                    <a href="<?=$alamat_web?>/pegawai/proses_hapus.php?id_pegawai=<?=$d['id_pegawai']?>" class="btn btn-flat  btn btn-danger">Hapus</a>
                    <a href="<?=$alamat_web?>/pegawai/edit.php?id_pegawai=<?=$d['id_pegawai']?>" class="btn btn-flat  btn btn-primary">Edit</a></td>
                </tr>
                <?php 
  $no++;
  }
