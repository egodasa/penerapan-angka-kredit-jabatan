    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Input Sub Unsur Kegiatan</h3>
        </div>
        <div class="box-body table-responsive ">
            <form method="POST" action="<?=$alamat_web?>/unsur/sub-unsur/proses_tambah.php" enctype="multipart/form-data">
              <input class="form-control"  type="hidden" name="id_unsur" value="<?=$_GET['id_unsur']?>" />
              <div class="form-group">
                <label class="form-label">Nama Sub Unsur Kegiatan</label>
              ...
              <div class="form-group">
                <label class="form-label">Jenis Sub Unsur Kegiatan</label>
