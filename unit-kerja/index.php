      ...
      <section class="content">
        <div class="box">
          ...
          <div class="box-body table-responsive ">
            <a href="<?=$alamat_web?>/unit-kerja/tambah.php" class="btn btn-flat btn-success">Tambah Data</a>
...
?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?=$alamat_web?>/unit-kerja/edit.php?id_unit_kerja=<?=$d['id_unit_kerja']?>" class="btn btn-flat btn-primary">Edit</a></td>
                </tr>
                <?php 
  $no++;
  }
