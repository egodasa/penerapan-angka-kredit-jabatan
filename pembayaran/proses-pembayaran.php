...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  $query->bindParam("dibayar", $_POST['nilai_dibayar'], PDO::PARAM_INT);
  $query->bindParam("kembalian", $_POST['nilai_kembalian'], PDO::PARAM_INT);
  $query->bindParam("id_pesan", $_POST['id_pesan']);
  $query->execute();
}

// Arahkan menu ke halaman menu kembali
header("Location: $alamat_web/pembayaran/detail-pesan.php?id_pesan=$_POST[id_pesan]");
?>
